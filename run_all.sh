...
cd ~/gamejam-2019/FindRealHumansNearYouGame/gpt2api/src && sudo flask run --host 0.0.0.0 --port 8080 &

# Run Flask API for Game State (port 9283)
cd ~/gamejam-2019/FindRealHumansNearYouGame/flaskapi/src && sudo flask run --host 0.0.0.0 --port 465 &
